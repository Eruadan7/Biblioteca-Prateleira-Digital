...
INSERT INTO ImagemIlustrativa(imagem BIT, capa BIT, contracapa BIT) 
VALUES(b'', b'', b''),
(b'', b'', b''),
(b'', b'', b''),
(b'', b'', b''),
...
INSERT INTO Biblioteca(nome_biblioteca) -- ok
...
VALUES(1, 1, 10.00, '2024-03-251', '2024-04-05'),
(2, 1, '2024-03-25', '2024-04-05'),
(3, 1, '2024-03-25', '2024-04-05');

INSERT INTO Cliente(id_biblioteca, nome_cliente, cpf, quantidade_locacoes, quantidade_multas) 
VALUES(1, 'Sócrates', '00000000000', 1, 1),
(1, 'Platão', '00000000001', 1, 1),
(1, 'Aristóteles', '00000000002', 1, 1);

INSERT INTO Multa(id_livro_locado, perdido, danificado, atrasado)
VALUES(1, 00.00, 30.00),
(2, 00.00, 00.00, 10.00),
(3, 80.00);